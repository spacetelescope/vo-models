...
class Search(vr.Capability, nsmap=NSMAP):
    ...
    Parameters:
        ...
        extension_search_support:
            (element) - (deprecated) Used in Registry Interfaces 1.0 to indicate what VOResource extensions a search interface supported.
        optional_protocol:
...
class Authority(vr.Resource, nsmap=NSMAP):
    ...
    managing_org: vr.ResourceName = element(tag="managingOrg")
